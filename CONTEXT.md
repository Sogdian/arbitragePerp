...
```
Закр (min): -4.27% | Откр (max): 3.92% | long_fr: -0.25 | short_fr: 0.01 | fr_spread: 0.263
```
...
- `Закр (min): -4.27%` - при закрытии будет убыток 4.27% из-за разницы цен (цены еще не сошлись)
