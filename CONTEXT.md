...
- Для каждой пары бирж (Long на одной, Short на другой) выполняет:
  ...
  - Проверку ликвидности (параметры из `SCAN_COIN_INVEST`, `max_spread_bps=30.0`, `max_impact_bps=50.0`)
  - Проверку новостей (делистинг и безопасность за 60 дней, с кешем)
  - Определение вердикта (✅ арбитражить / ❌ не арбитражить)
- Формирует строку вывода в формате: `Long {биржа} Цена: ..., Фандинг: ... | Short {биржа} Цена: ..., Фандинг: ... | Спред на цену: ... | Спред на фандинги: ... | {вердикт}`
